...
public class CassandraIndexAspectTest extends AbstractIndexingTest {
    ...
    private void testMultiValueIndexes() throws Throwable {
        ...
        persist(DATA_KS, DATA_CF, KEY1, data);
        Map<String, String> row = select(INDEX_KS, INDEX_CF, MULTI_VALUE_INDEX_NAME);
        assertEquals("Number of indexes", 1, row.size());
        Iterator<String> indexes = row.keySet().iterator();
        ...
        persist(DATA_KS, DATA_CF, KEY1, data);
        row = select(INDEX_KS, INDEX_CF, MULTI_VALUE_INDEX_NAME);
        assertEquals("Number of indexes", 2, row.size());
        indexes = row.keySet().iterator();
        assertIndex(indexes.next(), "value 1", KEY1);
        ...
        delete(DATA_KS, DATA_CF, KEY2, MULTI_VALUE_COLUMN + "[2]");
        row = select(INDEX_KS, INDEX_CF, MULTI_VALUE_INDEX_NAME);
        assertEquals("Number of indexes", 3, row.size());
        indexes = row.keySet().iterator();
        assertIndex(indexes.next(), "value 1", KEY1);
        ...
        delete(DATA_KS, DATA_CF, KEY2, MULTI_VALUE_COLUMN + "[1]");
        row = select(INDEX_KS, INDEX_CF, MULTI_VALUE_INDEX_NAME);
        assertEquals("Number of indexes", 2, row.size());
        indexes = row.keySet().iterator();
        assertIndex(indexes.next(), "value 1", KEY1);
    ...
    private void testSingleAndMultiValueIndexes() throws Throwable {
        ...
        Iterator<String> indexes = row.keySet().iterator();
        assertIndex(indexes.next(), "value 1", KEY1);
        row = select(INDEX_KS, INDEX_CF, MULTI_VALUE_INDEX_NAME2);
        assertEquals("Number of indexes", 1, row.size());
        indexes = row.keySet().iterator();
        ...
        delete(DATA_KS, DATA_CF, KEY1, IDX1_COL);
        row = select(INDEX_KS, INDEX_CF, MULTI_VALUE_INDEX_NAME);
        assertEquals("Number of indexes", 0, row.size());
        row = select(INDEX_KS, INDEX_CF, MULTI_VALUE_INDEX_NAME2);
        assertEquals("Number of indexes", 0, row.size());
    ...
    private void assertData(String keyspace, String columnFamily, Map<String, Map<String, String>> expectedRows)
            throws Throwable {
